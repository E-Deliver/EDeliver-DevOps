...
class AuthenticationServiceTest {
    ...
    void authenticate_Success() {
        LoginUserDTO loginUserDTO = new LoginUserDTO("email@example.com", "password");
    ...
    void authenticate_Fail_EmailNotFound() {
        LoginUserDTO loginUserDTO = new LoginUserDTO("wrong@example.com", "password");
    ...
    void authenticate_Fail_WrongPassword() {
        LoginUserDTO loginUserDTO = new LoginUserDTO("email@example.com", "wrongPassword");
        Utilisateur utilisateur = new Utilisateur();
        utilisateur.setMotDePasse("encodedPassword");
